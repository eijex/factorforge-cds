...
# aa_identity (1.0) is not scannable as a bare literal — too many false positives from
# normalized weights and scores. Registry-tracked via test_registry_production_sync.py instead.
